...
contextBridge.exposeInMainWorld('desktopWindow', {
  ...
  scanLocalMusicFolder: (folderPath) => ipcRenderer.invoke('mineradio-local-music-scan-folder', String(folderPath || '')),
  resolveLocalMusicFile: (filePath, options) => ipcRenderer.invoke('mineradio-local-music-resolve-file', String(filePath || ''), options || {}),
  getLocalLibraryFolders: () => ipcRenderer.invoke('mineradio-local-library-folders-get'),
  setLocalLibraryFolders: (folderPaths) => ipcRenderer.invoke('mineradio-local-library-folders-set', Array.isArray(folderPaths) ? folderPaths : []),
  getCustomCovers: () => ipcRenderer.invoke('mineradio-custom-covers-get'),
  setCustomCovers: (payload) => ipcRenderer.invoke('mineradio-custom-covers-set', payload || {}),
  ...
  setLocalOnlineMetadataCache: (payload) => ipcRenderer.invoke('mineradio-local-online-metadata-cache-set', payload || {}),
