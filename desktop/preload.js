...
contextBridge.exposeInMainWorld('desktopWindow', {
  ...
  resolveLocalMusicFile: (filePath, options) => ipcRenderer.invoke('mineradio-local-music-resolve-file', filePath, options || {}),
  flushLocalAudioMetadataCache: () => ipcRenderer.invoke('mineradio-local-audio-metadata-cache-flush'),
  showLocalMusicInFolder: (filePath) => ipcRenderer.invoke('mineradio-local-music-show-in-folder', filePath),
  getLocalLyricsCache: (cacheKey) => ipcRenderer.invoke('mineradio-local-lyrics-cache-get', cacheKey),
  setLocalLyricsCache: (cacheKey, payload) => ipcRenderer.invoke('mineradio-local-lyrics-cache-set', cacheKey, payload || {}),
