...
module.exports = async function afterPack(context) {
  ...
  // Mineradio owns its update downloader and cache path. Shipping the
  // electron-builder updater manifest recreates an unrelated LocalAppData
  // cache that older local builds could not clean up.
