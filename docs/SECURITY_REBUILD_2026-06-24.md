...
- Active source repository: `D:\projects\Mineradio`
...
- Huorong detections shown by the user were concentrated in the old backup workspace; current backup boundary is `D:\projects\Mineradio\工作区备份`, and old `node_modules`, old builder caches, and old packaged backup files must stay quarantined from release sources.
