...
(function loadMineradioIndexModules() {
  ...
  const modulePaths = [
    ...
    'js/modules/05-playback/02a-listen-report-store.js',
    'js/modules/05-playback/03-home-discover-weather.js',
    'js/modules/05-playback/03a-home-dashboard.js',
    'js/modules/05-playback/03b-home-listen-ranking.js',
    'js/modules/05-playback/03c-music-library-wall.js',
    'js/modules/05-playback/03d-listen-report-view.js',
    'js/modules/05-playback/03e-listen-report-posters.js',
    ...
    'js/modules/05-playback/06a-download-center.js',
    'js/modules/05-playback/07-search.js',
    'js/modules/05-playback/07a-search-wall.js',
    'js/modules/05-playback/08-audio-graph-controls.js',
    'js/modules/05-playback/08a-playback-tuning-eq.js',
    ...
    'js/modules/05-playback/17-mv-theater.js',
    ...
    'js/modules/10-shell/04a-cube-remote-controller.js',
    'js/modules/10-shell/04b-lan-remote-controller.js',
